            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="outer-repeater" enctype="multipart/form-data" action="{{ url('/dashboard/curses/create')  }}" method="POST">
                            @csrf
                            <div data-repeater-list="outer-group" class="outer">
                                <div data-repeater-item class="outer">
                                    <div class="mb-3">
                                        <label class="form-label" for="formname">Kurs nomi :</label>
                                        <input type="text" name="name" class="form-control" id="formname" placeholder="Kurs nomini kiriting">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="price">Kurs uchun tolov summasi (Bir oy uchun):</label>
                                        <input type="number" name="narxi" class="form-control"  placeholder="Kurs narx">
                                    </div>
